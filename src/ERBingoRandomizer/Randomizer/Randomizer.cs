...
public partial class BingoRandomizer
{
    ...
    private void AddItemWithLotId(int id, int itemId, int itemCat, int itemCount)
    {
        ...
        row.Cells.FirstOrDefault(c => c.Def.InternalName == "lotItemBasePoint01").SetValue((ushort)1000);
    ...
    private void unlockSeason3Graces()
    {
        ...
        var itemsToGive = new[]
        {
            ...
            (10010000, 2, 1), // 神皮剥制剑
            (10030000, 2, 1), // 骑士双头剑
            (10050000, 2, 1), // 艾琉诺拉的双头刀
            (10060000, 2, 1), // 丰饶与腐败双刃剑
            (10080000, 2, 1), // 石像鬼双头剑
            (10090000, 2, 1), // 石像鬼黑双头剑
            (11000000, 2, 1), // 锤矛
            (11010000, 2, 2), // 棍棒
            (11030000, 2, 2), // 弯曲棍棒
            (11040000, 2, 2), // 战镐
            ...
            (31290000, 2, 1), // 红纹熨斗形盾
            (31300000, 2, 1), // 蓝纹熨斗形盾
            (31310000, 2, 1), // 日蚀纹熨斗形盾
            (31320000, 2, 1), // 逆鹰纹熨斗形盾
            (31330000, 2, 1), // 熨斗形盾
            (31340000, 2, 1), // 黑皮盾
            (32000000, 2, 1), // 龙塔盾
            (32020000, 2, 1), // 名门大盾
            ...
            (33200000, 2, 1), // 学院辉石杖
            (33210000, 2, 1), // 卡利亚辉石杖
            (33230000, 2, 1), // 亚兹勒的辉石杖
            (33240000, 2, 1), // 卢瑟特的辉石杖
            (33250000, 2, 1), // 陨石杖
            (33260000, 2, 1), // 罪人杖
            (33270000, 2, 1), // 腐败结晶杖
            (33280000, 2, 1), // 丧失杖
            (34000000, 2, 1), // 指头圣印记
            (34010000, 2, 1), // 狩猎神祇圣印记
            (34020000, 2, 1), // 巨人圣印记
            (34030000, 2, 1), // 碎石圣印记
            (34040000, 2, 1), // 爪痕圣印记
            (34060000, 2, 1), // 黄金律法圣印记
            (34070000, 2, 1), // 黄金树圣印记
            (34080000, 2, 1), // 龙飨印记
            (34090000, 2, 1), // 癫火圣印记
            (40000000, 2, 1), // 短弓
        ...
        for (var i = 0; i < itemsToGive.Length; i++)
        {
            ...
            if (cat == 2 && id < 50000000)
            {
                for (var j = 0; j < count; j++)
                {
                    if (itemLotId % 10 == 0)
                        newInstrs.Add(new EMEVD.Instruction(2003, 4, new List<object> { itemLotId }));
                    AddItemWithLotId(itemLotId, id, cat, 1);
                    itemLotId++;
                }
            }
            else
            {
                if (itemLotId % 10 == 0)
                    newInstrs.Add(new EMEVD.Instruction(2003, 4, new List<object> { itemLotId }));
                AddItemWithLotId(itemLotId, id, cat, count);
                itemLotId++;
            }
        }
